    ...
    if (toolId === 'view-metadata') {
      ...
      try {
        ...
        if (info && Object.keys(info).length > 0) {
          ...
          infoSection.ul.innerHTML = `<li><span class="text-gray-500 italic">– Nem található Info-szótár adat –</span></li>`;
        }
        ...
        if (fieldObjects && Object.keys(fieldObjects).length > 0) {
          ...
          fieldsSection.ul.innerHTML = `<li><span class="text-gray-500 italic">– Nem található interaktív űrlapmező –</span></li>`;
        }
        ...
        if (rawXmpString) {
          try {
            ...
            if (xmpSection.ul.children.length === 0) {
              xmpSection.ul.innerHTML = `<li><span class="text-gray-500 italic">– Nem található értelmezhető XMP-tulajdonság –</span></li>`;
            }
          } catch (xmlError) {
          ...
          xmpSection.ul.innerHTML = `<li><span class="text-gray-500 italic">– Nem található XMP-metaadat –</span></li>`;
        }
