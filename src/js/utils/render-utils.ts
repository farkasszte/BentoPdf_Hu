...
export function createPlaceholder(
  ...
  placeholder.className =
    'page-thumbnail relative cursor-move flex flex-col items-center gap-1 p-2 border-2 border-slate-600 rounded-lg bg-slate-800 transition-colors';
  ...
  skeletonContainer.className =
    'relative w-full h-36 bg-slate-700 rounded-md animate-pulse flex items-center justify-center';

  const loadingText = document.createElement('span');
  loadingText.className = 'text-slate-500 text-xs';
  loadingText.textContent = 'Betöltés...';
