...
function getOrCreateModal(): HTMLElement {
  ...
  modal.innerHTML = `
    <button id="preview-close" class="absolute top-4 right-4 text-white/70 hover:text-white z-10 transition-colors" title="Bezárás (Esc)">
        ...
        <button id="preview-prev" class="absolute left-4 top-1/2 -translate-y-1/2 text-white/50 hover:text-white transition-colors p-2" title="Előző oldal">
        ...
        <button id="preview-next" class="absolute right-4 top-1/2 -translate-y-1/2 text-white/50 hover:text-white transition-colors p-2" title="Következő oldal">
