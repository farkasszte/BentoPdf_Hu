  ...
  let summaryHTML = `
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
      <div class="bg-slate-950 border border-slate-700 rounded-lg p-4">
        <p class="text-sm text-slate-400 mb-1">Total Pages</p>
        <p class="text-2xl font-bold text-white">${stats.totalPages}</p>
      </div>
      <div class="bg-slate-950 border border-slate-700 rounded-lg p-4">
        <p class="text-sm text-slate-400 mb-1">Unique Page Sizes</p>
        <p class="text-2xl font-bold text-white">${stats.uniqueSizesCount}</p>
      </div>
      <div class="bg-slate-950 border border-slate-700 rounded-lg p-4">
        <p class="text-sm text-slate-400 mb-1">Document Type</p>
      ...
      <div class="bg-yellow-900/20 border border-yellow-500/30 rounded-lg p-4 mb-4">
        <div class="flex items-start gap-3">
          ...
          <div>
            ...
            <p class="text-sm text-slate-300 mb-3">This document contains pages with different dimensions:</p>
