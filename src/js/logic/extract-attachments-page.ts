...
async function updateUI() {
  ...
  if (pageState.files.length > 0) {
    ...
    countSpan.className = 'font-medium text-slate-200 text-sm mb-1';
    countSpan.textContent = `${pageState.files.length} PDF-fájl kiválasztva`;
