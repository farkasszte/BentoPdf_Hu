...
async function removeMetadata() {
  ...
  if (loaderText) loaderText.textContent = 'Összes metaadat eltávolítása...';
  ...
  try {
    ...
    showAlert('Siker', 'Metadata removed successfully!', 'success', () => {
      resetState();
    });
  } catch (e) {
    console.error(e);
    showAlert('Hiba', 'An error occurred while trying to remove metadata.');
  } finally {
    if (loaderModal) loaderModal.classList.add('hidden');
  }
}
