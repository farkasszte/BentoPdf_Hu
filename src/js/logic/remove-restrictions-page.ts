...
async function removeRestrictions() {
  ...
  try {
    ...
    if (loaderText) loaderText.textContent = 'Inicializálás...';
    ...
    if (loaderText) loaderText.textContent = 'Korlátozások eltávolítása...';
    ...
    try {
      ...
      throw new Error(
        'Failed to remove restrictions: ' + (qpdfMsg || 'Ismeretlen hiba'),
        { cause: qpdfError }
      );
    }
